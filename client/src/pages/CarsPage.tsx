...
const sampleCars: Car[] = [
  ...
  },
  {
    ...
    pricePerDay: 900,
    category: 'luxury',
    images: ['https://gt-chairs.com/wp-content/uploads/bentley-continental-gt-08.jpg'],
    transmission: 'automatic',
    fuelType: 'petrol',
    seats: 4,
  ...
  },
  {
    ...
    pricePerDay: 800,
    category: 'sports',
    images: ['https://th.bing.com/th/id/OIP.KXad9ED3ZjjZXn9ARl6QfAHaEK?rs=1&pid=ImgDetMain'],
    transmission: 'automatic',
    fuelType: 'petrol',
    seats: 2,
    ...
    },
  {
    ...
    pricePerDay: 900,
    category: 'luxury',
    images: ['https://dmc.ag/wp-content/uploads/2021/10/DMC_Chiron_New.jpg'],
    transmission: 'automatic',
    fuelType: 'petrol',
    seats: 2,
    description: 'The Bugatti Continental GT combines exquisite luxury with sporting performance.',
    features: ['v12 Engine', 'All-Wheel Drive', 'Handcrafted Interior', 'Naim Audio System'],
    available: true,
    location: 'pune',
    rating: 4.7,
    reviewCount: 19,
